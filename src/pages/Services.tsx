    ...
    <div id="services" className="section">
      ...
      <div className="md:flex mx-auto gap-10">
        <div className="text-center bg-yellow-300 rounded-xl my-8 md:my-10 shadow-md p-5">
          ...
          <h2 className="text-2xl md:text-3xl font-bold ">Website Designing</h2>
          <p className="text-sm md:text-md py-2 md:py-3 text-slate-600 opacity-90 leading-6 md:leading-7">
            By receiving the figma file from a UX resource, I am able to create
            mock up's using CSS or by using a CSS library or a framework. I am
            able to design the layout using Flexbox and Grid.
          </p>
        </div>
        <div className="text-center bg-yellow-300 rounded-xl my-8 md:my-10 shadow-md p-5">
          ...
          <p className="text-sm md:text-md py-2 md:py-3 text-slate-600 opacity-90 leading-6 md:leading-7">
            Responsible for the design and development of websites. Ensure that
            sites meet user expectations by ensuring they look good, run
            smoothly and offer easy access points with no loading issues between
